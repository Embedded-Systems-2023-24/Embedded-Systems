...
architecture behave of compute_matrices_control_s_axi is
    ...
    constant ADDR_DIRECTION_MATRIX_0_DATA_0 : INTEGER := 16#34#;
    constant ADDR_DIRECTION_MATRIX_0_DATA_1 : INTEGER := 16#38#;
    constant ADDR_DIRECTION_MATRIX_0_CTRL   : INTEGER := 16#3c#;
    constant ADDR_DIRECTION_MATRIX_1_DATA_0 : INTEGER := 16#40#;
    constant ADDR_DIRECTION_MATRIX_1_DATA_1 : INTEGER := 16#44#;
    constant ADDR_DIRECTION_MATRIX_1_CTRL   : INTEGER := 16#48#;
