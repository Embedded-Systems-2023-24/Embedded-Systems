...
set_property -name {STEPS.PLACE_DESIGN.ARGS.MORE OPTIONS} -value {-retiming} -objects [get_runs $impl_runs]
set_property -name STEPS.PHYS_OPT_DESIGN.IS_ENABLED -value true -objects [get_runs $impl_runs]
set_property -name STEPS.POST_ROUTE_PHYS_OPT_DESIGN.IS_ENABLED -value true -objects [get_runs $impl_runs]
