...
#
# rebuild.tcl: Tcl script for re-creating project 'zedboard_base'
#
# Generated by Vivado on Wed Feb 09 12:19:14 EET 2022
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
   "/local/embedded/labs/vitis-acceleration-tutorial/platform-build/hw/build/zedboard_base/zedboard_base.srcs/sources_1/bd/zedboard_base/zedboard_base.bd" \
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "zedboard_base"
...
set_property -name "platform.name" -value "zedboard_202020_1" -objects $obj
set_property -name "platform.vendor" -value "xilinx.com" -objects $obj
set_property -name "platform.version" -value "202020.1" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/zedboard_base.srcs/sources_1/bd/zedboard_base/zedboard_base.bd" ]\
]
set imported_files [import_files -fileset sources_1 $files]

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse zedboard_base.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/zedboard_base.gen/sources_1/bd/zedboard_base/hdl/zedboard_base_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse zedboard_base.bd] -top]
...
set file "zedboard_base/zedboard_base.bd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "pfm_name" -value "xilinx.com:xd:zedboard_202020_1:202020.1" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj


# Set 'sources_1' fileset properties
set obj [get_filesets sources_1]
set_property -name "top" -value "zedboard_base_wrapper" -objects $obj
