...
proc create_hier_cell_System_DPA { parentCell nameHier } {
  ...
  # Create instance: dpa_converter, and set properties
  set dpa_converter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 dpa_converter ]
  ...
  set_property -dict [ list \
   CONFIG.C_AXI4_BASEADDR {0x41810000} \
   CONFIG.C_AXI4_HIGHADDR {0x41811FFF} \
  ...
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/compute_matrices_1} [get_bd_cells /System_DPA/dpa_mon0]
  ...
  set_property HDL_ATTRIBUTE.DPA_IP_FULLNAME {/compute_matrices_1/m_axi_gmem-DDR} [get_bd_cells /System_DPA/dpa_mon1]
  ...
  connect_bd_intf_net -intf_net compute_matrices_1_m_axi_gmem [get_bd_intf_pins MON_M_AXI] [get_bd_intf_pins dpa_mon1/MON_M_AXI]
  connect_bd_intf_net -intf_net dpa_cdc_M_AXIS [get_bd_intf_pins dpa_cdc/M_AXIS] [get_bd_intf_pins dpa_fifo/AXI_STR_RXD]
  connect_bd_intf_net -intf_net dpa_converter_M_AXIS [get_bd_intf_pins dpa_cdc/S_AXIS] [get_bd_intf_pins dpa_converter/M_AXIS]
  ...
  connect_bd_intf_net -intf_net dpa_hub_M_AXIS [get_bd_intf_pins dpa_converter/S_AXIS] [get_bd_intf_pins dpa_hub/M_AXIS]
  ...
  connect_bd_intf_net -intf_net interconnect_axilite_M01_AXI [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon1/MON_S_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets interconnect_axilite_M01_AXI] [get_bd_intf_pins MON_S_AXI] [get_bd_intf_pins dpa_mon0/S_AXI_MON]
  ...
  connect_bd_intf_net -intf_net interconnect_axilite_M03_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins dpa_reg_slice/S_AXI]

  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins trace_clk] [get_bd_pins dpa_cdc/m_axis_aclk] [get_bd_pins dpa_cdc/s_axis_aclk] [get_bd_pins dpa_converter/aclk] [get_bd_pins dpa_ctrl_interconnect/ACLK] [get_bd_pins dpa_ctrl_interconnect/M00_ACLK] [get_bd_pins dpa_ctrl_interconnect/M01_ACLK] [get_bd_pins dpa_ctrl_interconnect/M02_ACLK] [get_bd_pins dpa_ctrl_interconnect/M03_ACLK] [get_bd_pins dpa_ctrl_interconnect/S00_ACLK] [get_bd_pins dpa_fifo/s_axi_aclk] [get_bd_pins dpa_hub/mon_clk] [get_bd_pins dpa_hub/trace_clk] [get_bd_pins dpa_mon0/mon_clk] [get_bd_pins dpa_mon0/trace_clk] [get_bd_pins dpa_mon1/mon_clk] [get_bd_pins dpa_mon1/trace_clk] [get_bd_pins dpa_reg_slice/aclk] [get_bd_pins dpa_reg_slice2/aclk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins trace_rst] [get_bd_pins dpa_cdc/m_axis_aresetn] [get_bd_pins dpa_cdc/s_axis_aresetn] [get_bd_pins dpa_converter/aresetn] [get_bd_pins dpa_ctrl_interconnect/ARESETN] [get_bd_pins dpa_ctrl_interconnect/M00_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M01_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M02_ARESETN] [get_bd_pins dpa_ctrl_interconnect/M03_ARESETN] [get_bd_pins dpa_ctrl_interconnect/S00_ARESETN] [get_bd_pins dpa_fifo/s_axi_aresetn] [get_bd_pins dpa_hub/mon_resetn] [get_bd_pins dpa_hub/trace_resetn] [get_bd_pins dpa_mon0/mon_resetn] [get_bd_pins dpa_mon0/trace_rst] [get_bd_pins dpa_mon1/mon_resetn] [get_bd_pins dpa_mon1/trace_rst] [get_bd_pins dpa_reg_slice/aresetn] [get_bd_pins dpa_reg_slice2/aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: compute_matrices_1, and set properties
  set compute_matrices_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:compute_matrices:1.0 compute_matrices_1 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI1 [get_bd_intf_pins axi_interconnect_lpd/M00_AXI] [get_bd_intf_pins ps7/S_AXI_HP0]
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins interconnect_axifull/M00_AXI] [get_bd_intf_pins ps7/S_AXI_HP1]
  ...
  connect_bd_intf_net -intf_net compute_matrices_1_m_axi_gmem [get_bd_intf_pins axi_interconnect_lpd/S01_AXI] [get_bd_intf_pins compute_matrices_1/m_axi_gmem]
connect_bd_intf_net -intf_net [get_bd_intf_nets compute_matrices_1_m_axi_gmem] [get_bd_intf_pins System_DPA/MON_M_AXI] [get_bd_intf_pins axi_interconnect_lpd/S01_AXI]
  connect_bd_intf_net -intf_net interconnect_axilite_M01_AXI [get_bd_intf_pins compute_matrices_1/s_axi_control] [get_bd_intf_pins interconnect_axilite/M01_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets interconnect_axilite_M01_AXI] [get_bd_intf_pins System_DPA/MON_S_AXI] [get_bd_intf_pins interconnect_axilite/M01_AXI]
  ...
  connect_bd_intf_net -intf_net interconnect_axilite_M03_AXI [get_bd_intf_pins System_DPA/S_AXI] [get_bd_intf_pins interconnect_axilite/M03_AXI]
  ...
  connect_bd_intf_net -intf_net ps_7_M_AXI_HPM0_LPD [get_bd_intf_pins interconnect_axilite/S00_AXI] [get_bd_intf_pins ps7/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins System_DPA/trace_clk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_lpd/ACLK] [get_bd_pins axi_interconnect_lpd/M00_ACLK] [get_bd_pins axi_interconnect_lpd/S00_ACLK] [get_bd_pins axi_interconnect_lpd/S01_ACLK] [get_bd_pins axi_vip_0/aclk] [get_bd_pins axi_vip_1/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins compute_matrices_1/ap_clk] [get_bd_pins interconnect_axifull/ACLK] [get_bd_pins interconnect_axifull/M00_ACLK] [get_bd_pins interconnect_axifull/S00_ACLK] [get_bd_pins interconnect_axilite/ACLK] [get_bd_pins interconnect_axilite/M00_ACLK] [get_bd_pins interconnect_axilite/M01_ACLK] [get_bd_pins interconnect_axilite/M02_ACLK] [get_bd_pins interconnect_axilite/M03_ACLK] [get_bd_pins interconnect_axilite/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_HP0_ACLK] [get_bd_pins ps7/S_AXI_HP1_ACLK]
  connect_bd_net -net Net [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins ps7/FCLK_RESET0_N]
  ...
  connect_bd_net -net compute_matrices_1_interrupt [get_bd_pins axi_intc_0_intr_1_interrupt_concat/In1] [get_bd_pins compute_matrices_1/interrupt]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_lpd/ARESETN] [get_bd_pins axi_interconnect_lpd/M00_ARESETN] [get_bd_pins axi_interconnect_lpd/S00_ARESETN] [get_bd_pins axi_interconnect_lpd/S01_ARESETN] [get_bd_pins axi_vip_1/aresetn] [get_bd_pins interconnect_axifull/ARESETN] [get_bd_pins interconnect_axifull/M00_ARESETN] [get_bd_pins interconnect_axifull/S00_ARESETN] [get_bd_pins interconnect_axilite/ARESETN] [get_bd_pins interconnect_axilite/M00_ARESETN] [get_bd_pins interconnect_axilite/M01_ARESETN] [get_bd_pins interconnect_axilite/S00_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins System_DPA/trace_rst] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins compute_matrices_1/ap_rst_n] [get_bd_pins interconnect_axilite/M02_ARESETN] [get_bd_pins interconnect_axilite/M03_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net ps_7_pl_clk0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps7/FCLK_CLK0]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_vip_0/Master_AXI] [get_bd_addr_segs ps7/S_AXI_HP1/HP1_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_vip_1/Master_AXI] [get_bd_addr_segs ps7/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces compute_matrices_1/Data_m_axi_gmem] [get_bd_addr_segs ps7/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs compute_matrices_1/s_axi_control/Reg] -force
  assign_bd_address -offset 0x40010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs System_DPA/dpa_fifo/S_AXI/Mem0] -force
  assign_bd_address -offset 0x41810000 -range 0x00002000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs System_DPA/dpa_fifo/S_AXI_FULL/Mem1] -force
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs System_DPA/dpa_hub/S_AXI/reg0] -force
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs System_DPA/dpa_mon0/S_AXI/reg0] -force
  assign_bd_address -offset 0x44A20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs System_DPA/dpa_mon1/S_AXI/reg0] -force
  ...
  set_property PFM_NAME {xilinx.com:xd:zedboard_202020_1:202020.1} [get_files [current_bd_design].bd]
  set_property PFM.IRQ {intr {id 0 range 32}} [get_bd_cells /axi_intc_0]
  set_property PFM.AXI_PORT {S01_AXI {memport "S_AXI_HP" sptag "" memory ""} S02_AXI {memport "S_AXI_HP" sptag "" memory ""} S03_AXI {memport "S_AXI_HP" sptag "" memory ""} S04_AXI {memport "S_AXI_HP" sptag "" memory ""} S05_AXI {memport "S_AXI_HP" sptag "" memory ""} S06_AXI {memport "S_AXI_HP" sptag "" memory ""} S07_AXI {memport "S_AXI_HP" sptag "" memory ""} S08_AXI {memport "S_AXI_HP" sptag "" memory ""} S09_AXI {memport "S_AXI_HP" sptag "" memory ""} S10_AXI {memport "S_AXI_HP" sptag "" memory ""} S11_AXI {memport "S_AXI_HP" sptag "" memory ""} S12_AXI {memport "S_AXI_HP" sptag "" memory ""} S13_AXI {memport "S_AXI_HP" sptag "" memory ""} S14_AXI {memport "S_AXI_HP" sptag "" memory ""} S15_AXI {memport "S_AXI_HP" sptag "" memory ""}} [get_bd_cells /axi_interconnect_lpd]
  ...
  set_property PFM.AXI_PORT {S01_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S02_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S03_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S04_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S05_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S06_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S07_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S08_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S09_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S10_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S11_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S12_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S13_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S14_AXI {memport "S_AXI_HP" sptag "HP0" memory ""} S15_AXI {memport "S_AXI_HP" sptag "HP0" memory ""}} [get_bd_cells /interconnect_axifull]
  ...
  set_property PFM.AXI_PORT {M_AXI_GP1 {memport "M_AXI_GP" sptag "" memory "" is_range "false"} S_AXI_HP2 {memport "S_AXI_HP" sptag "HP2" memory "" is_range "false"} S_AXI_HP3 {memport "S_AXI_HP" sptag "HP3" memory "" is_range "false"}} [get_bd_cells /ps7]
