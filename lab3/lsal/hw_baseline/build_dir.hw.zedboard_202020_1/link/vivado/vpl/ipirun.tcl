...
set vpl_output_dir "/home/inf2021/iathanasi/embedded/Embedded-Systems/lab3/lsal/hw_baseline/build_dir.hw.zedboard_202020_1/link/int"
set input_dir "input"
set steps_log "../../link.steps.log"
set kernel_ip_dirs {
  {/home/inf2021/iathanasi/embedded/Embedded-Systems/lab3/lsal/hw_baseline/build_dir.hw.zedboard_202020_1/link/int/xo/ip_repo/xilinx_com_hls_compute_matrices_1_0}}
set install_ip_cache "/opt/Xilinx/Vitis/2020.2/data/cache/xilinx"
...
set hw_platform_info [dict create \
  ...
  hw_platform_file             "/opt/Xilinx/Vitis/2020.2/platforms/zedboard_202020_1/hw/zedboard_202020_1.xsa" \
  hw_platform_part             "xc7z020clg484-1" \
  hw_platform_vbnv             "xilinx.com:xd:zedboard_202020_1:202020.1" \
  bb_locked_dcp                "" \
  bb_synth_dcp                 "" \
  ...
  hw_platform_board_part       "em.avnet.com:zed:part0:1.4" \
  link_output_format           "bitstream" \
  xpfm_file                    "/opt/Xilinx/Vitis/2020.2/platforms/zedboard_202020_1/zedboard_202020_1.xpfm" \
...
set config_info [dict create \
  ...
  is_debug_enabled           "1" \
  aie_archive_file         "/home/inf2021/iathanasi/embedded/Embedded-Systems/lab3/lsal/hw_baseline/build_dir.hw.zedboard_202020_1/link/int/system.aieprj" \
...
set data_profile_compute_matrices_1_M_AXI_GMEM [dict create \
  port compute_matrices_1/M_AXI_GMEM \
  option all \
];
set stall_profile_compute_matrices_1 [dict create \
  port compute_matrices_1 \
  option all \
];
set exec_profile_compute_matrices_1 [dict create \
  port compute_matrices_1 \
  option all \
];
set dict_profile [dict create \
  ...
  FIFO "8192" \
  AIE [list] \
  DATA [list $data_profile_compute_matrices_1_M_AXI_GMEM] \
  STALL [list $stall_profile_compute_matrices_1] \
  EXEC [list $exec_profile_compute_matrices_1] \
