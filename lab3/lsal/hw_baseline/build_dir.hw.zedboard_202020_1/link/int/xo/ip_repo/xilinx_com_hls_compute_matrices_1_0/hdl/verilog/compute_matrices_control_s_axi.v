...
#(parameter
    ...
    output wire [31:0]                   string1,
    output wire [31:0]                   string2,
    output wire [31:0]                   max_index,
    output wire [31:0]                   similarity_matrix,
    output wire [31:0]                   direction_matrix,
    output wire [31:0]                   N,
    output wire [31:0]                   M,
...
localparam
    ...
    ADDR_STRING1_CTRL             = 7'h14,
    ADDR_STRING2_DATA_0           = 7'h18,
    ADDR_STRING2_CTRL             = 7'h1c,
    ADDR_MAX_INDEX_DATA_0         = 7'h20,
    ADDR_MAX_INDEX_CTRL           = 7'h24,
    ADDR_SIMILARITY_MATRIX_DATA_0 = 7'h28,
    ADDR_SIMILARITY_MATRIX_CTRL   = 7'h2c,
    ADDR_DIRECTION_MATRIX_DATA_0  = 7'h30,
    ADDR_DIRECTION_MATRIX_CTRL    = 7'h34,
    ADDR_N_DATA_0                 = 7'h38,
    ADDR_N_CTRL                   = 7'h3c,
    ADDR_M_DATA_0                 = 7'h40,
    ADDR_M_CTRL                   = 7'h44,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_string1 = 'b0;
    reg  [31:0]                   int_string2 = 'b0;
    reg  [31:0]                   int_max_index = 'b0;
    reg  [31:0]                   int_similarity_matrix = 'b0;
    reg  [31:0]                   int_direction_matrix = 'b0;
    reg  [31:0]                   int_N = 'b0;
    reg  [31:0]                   int_M = 'b0;
