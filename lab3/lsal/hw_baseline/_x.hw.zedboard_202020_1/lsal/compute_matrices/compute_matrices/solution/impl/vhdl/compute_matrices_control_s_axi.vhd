...
port (
    ...
    string1               :out  STD_LOGIC_VECTOR(31 downto 0);
    string2               :out  STD_LOGIC_VECTOR(31 downto 0);
    max_index             :out  STD_LOGIC_VECTOR(31 downto 0);
    similarity_matrix     :out  STD_LOGIC_VECTOR(31 downto 0);
    direction_matrix      :out  STD_LOGIC_VECTOR(31 downto 0);
...
architecture behave of compute_matrices_control_s_axi is
    ...
    constant ADDR_STRING1_CTRL             : INTEGER := 16#14#;
    constant ADDR_STRING2_DATA_0           : INTEGER := 16#18#;
    constant ADDR_STRING2_CTRL             : INTEGER := 16#1c#;
    constant ADDR_MAX_INDEX_DATA_0         : INTEGER := 16#20#;
    constant ADDR_MAX_INDEX_CTRL           : INTEGER := 16#24#;
    constant ADDR_SIMILARITY_MATRIX_DATA_0 : INTEGER := 16#28#;
    constant ADDR_SIMILARITY_MATRIX_CTRL   : INTEGER := 16#2c#;
    constant ADDR_DIRECTION_MATRIX_DATA_0  : INTEGER := 16#30#;
    constant ADDR_DIRECTION_MATRIX_CTRL    : INTEGER := 16#34#;
    constant ADDR_N_DATA_0                 : INTEGER := 16#38#;
    constant ADDR_N_CTRL                   : INTEGER := 16#3c#;
    constant ADDR_M_DATA_0                 : INTEGER := 16#40#;
    constant ADDR_M_CTRL                   : INTEGER := 16#44#;
    ...
    signal int_string1         : UNSIGNED(31 downto 0) := (others => '0');
    signal int_string2         : UNSIGNED(31 downto 0) := (others => '0');
    signal int_max_index       : UNSIGNED(31 downto 0) := (others => '0');
    signal int_similarity_matrix : UNSIGNED(31 downto 0) := (others => '0');
    signal int_direction_matrix : UNSIGNED(31 downto 0) := (others => '0');
