...
set Library     "hls"
set IPName      "compute_matrices"
set Version     "1.0"
set DisplayName "Compute_matrices"
set Revision    "2113577220"
...
set xo_kernel_name "compute_matrices"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/inf2021/iathanasi/embedded/Embedded-Systems/lab3/lsal/hw_baseline/_x.hw.zedboard_202020_1/lsal/compute_matrices/compute_matrices/solution"
set debug_dir "/home/inf2021/iathanasi/embedded/Embedded-Systems/lab3/lsal/hw_baseline/_x.hw.zedboard_202020_1/lsal/compute_matrices/compute_matrices/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {compute_matrices_mul_32s_32s_32_2_1
...
## Variables
set Top "compute_matrices"
set TopNoPrefix "compute_matrices"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 string1 W 0x0 "Data signal of string1" {{0 32 string1 W 0 "Bit 31 to 0 of string1"}}} {0x18 string2 W 0x0 "Data signal of string2" {{0 32 string2 W 0 "Bit 31 to 0 of string2"}}} {0x20 max_index W 0x0 "Data signal of max_index" {{0 32 max_index W 0 "Bit 31 to 0 of max_index"}}} {0x28 similarity_matrix W 0x0 "Data signal of similarity_matrix" {{0 32 similarity_matrix W 0 "Bit 31 to 0 of similarity_matrix"}}} {0x30 direction_matrix W 0x0 "Data signal of direction_matrix" {{0 32 direction_matrix W 0 "Bit 31 to 0 of direction_matrix"}}} {0x38 N W 0x0 "Data signal of N" {{0 32 N W 0 "Bit 31 to 0 of N"}}} {0x40 M W 0x0 "Data signal of M" {{0 32 M W 0 "Bit 31 to 0 of M"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
