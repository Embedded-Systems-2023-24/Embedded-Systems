...
// print string1 Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = __xlx_offset_byte_param_string1;
...
// print string2 Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = __xlx_offset_byte_param_string2;
...
// print max_index Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = __xlx_offset_byte_param_max_index;
...
// print similarity_matrix Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = __xlx_offset_byte_param_similarity_matrix;
...
// print direction_matrix Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = __xlx_offset_byte_param_direction_matrix;
