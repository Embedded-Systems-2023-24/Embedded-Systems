...
#define FPADD_DEVICE_ID		   XPAR_FPADD_IP_0_DEVICE_ID
#define FPADD_ADDR			   XPAR_FPADD_IP_0_S00_AXI_BASEADDR
...
void BTN_Intr_Handler(void *InstancePtr)
{
	...
	if (btn_value == 1) {
		counter_value = 0;
		Xil_Out32(FPADD_ADDR, 1);
		for (int i=0; i<9999999; i++);
		Xil_Out32(FPADD_ADDR, 0);
	}
