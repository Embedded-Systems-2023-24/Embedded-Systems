...
architecture STRUCTURE of Cortex_A9_fpadd_ip_0_0_SSD_clock_module is
  signal \counter0__0\ : STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of Cortex_A9_fpadd_ip_0_0_SSD_clock_module_1 is
  signal counter0 : STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of Cortex_A9_fpadd_ip_0_0_fpadd_pipelined is
  ...
  signal pipe_Mantissa_shift_B : STD_LOGIC_VECTOR ( 23 to 23 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of e0_INST_0 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of e1_INST_0 : label is "soft_lutpair4";
begin
  \out\(0) <= \^out\(0);
e0_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
e1_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
SSD_clock_inst: entity work.Cortex_A9_fpadd_ip_0_0_SSD_clock_module_1
     port map (
      \counter_reg[2]_0\ => SSD_clock_inst_n_0,
...
g0_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
g1_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
architecture STRUCTURE of Cortex_A9_fpadd_ip_0_0_fpadd_system is
  ...
  signal \^digit_sel_reg_0\ : STD_LOGIC;
  signal fp_out : STD_LOGIC_VECTOR ( 30 to 30 );
begin
...
fpadder: entity work.Cortex_A9_fpadd_ip_0_0_fpadd_system
     port map (
      a0 => a0,
      a1 => a1,
      digit_sel_reg => digit_sel_reg,
