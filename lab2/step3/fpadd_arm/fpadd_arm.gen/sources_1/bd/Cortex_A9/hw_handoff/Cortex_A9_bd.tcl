...
proc create_root_design { parentCell } {
  ...
  set fpadd_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:fpadd_ip:1.0 fpadd_ip_0 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports swsbntsdd_8bits] [get_bd_intf_pins sw_8bit/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins fpadd_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
